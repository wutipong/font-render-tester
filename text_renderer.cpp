...
void TextRenderRightToLeft(SDL_Renderer* renderer, const SDL_Rect& bound, Font& font,
    const std::string& str, const SDL_Color& color,
    const hb_script_t& script) {
    if (!font.IsValid())
        return;
...
void TextRenderTopToBottom(SDL_Renderer* renderer, const SDL_Rect& bound, Font& font,
    const std::string& str, const SDL_Color& color,
    const hb_script_t& script) {
